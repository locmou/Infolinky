...
<html><head><meta charset="UTF-8">
    ...
    <style>
      ...
      #form-passe {display: none;padding:10px;text-align:left;margin:auto;}
...
<br>
<div id='form-passe'>
  <label for='passe'>Entrez le mot de passe du r&eacute;seau : </label>
        ...
        xhttp.onreadystatechange = function() { 
          if (this.readyState == 4 && this.status == 200) {
             ...
             for (var i=0;i<Wifi.length-1;i++) {
              ...
              GID("form-passe").style.display = "table-row";
