...
const char *ActionsJS = R"====(
  ...
  function creerAction(aActif, aTitre, aHost, aPort, aOrdreOn, aOrdreOff, aRepet,aTempo, aPeriodes) {
      var S = {
          Actif: aActif,
          Titre: aTitre,
          Host: aHost,
  ...
  function TracePlanning(iAct) {
      ...
      if (iAct > 0) {
          S += "<table class='tableAct'><tr>";       
          S += "<td>Host</td><td class='w15'><input type='text' id='host" + iAct + "' onmousemove='Disp(this)' ></td>";
          S += "<td>Ordre On</td><td class='w15'><input type='text' id='ordreOn" + iAct + "' onmousemove='Disp(this)'></td><td class='tm'>Répétition(s)</td>";
          S += "<td class='tm'>Temporisation(s)</td><td ><input id='adds' type='button' value='+' class='tbut' onclick='AddSub(1," + iAct + ")' onmousemove='Disp(this)'></td>";
          S += "</tr><tr>";
          S += "<td>Port</td><td class='w15'><input type='number' id='port" + iAct + "' onmousemove='Disp(this)'></td>";
          S += "<td>Ordre Off</td><td class='w15'><input type='text' id='ordreOff" + iAct + "' onmousemove='Disp(this)'></td>";
          ...
          S += "<td ><input id='adds' type='button' value='-' class='tbut'  onclick='AddSub(-1," + iAct + ")' onmousemove='Disp(this)'></td>";
          S += "</tr></table>";
      } else {
          S += "<div style='display:none'><input type='text' id='host" + iAct + "'><input type='text' id='ordreOn" + iAct + "'>";
          S += "<input type='text' id='ordreOff" + iAct + "'><input type='number' id='port" + iAct + "'><input type='number' id='repet" + iAct + "' ><input type='number' id='tempo" + iAct + "' ></div>";
      ...
      if (!blockEvent) {
          ...
          S += "<div class='fcontainer'><div >";
              ...
              if (iAct > 0) {
                  ...
                  S += "<div><small>Off : </small>Pw &gt;<input id='Pw_max_"+idZ+"' onmousemove='Disp(this)' type='number' value='"+Vmax+"' onchange='NewVal(this)'>W</div></div>";
      ...
      xhttp.onreadystatechange = function () {
          if (this.readyState == 4 && this.status == 200) {
              ...
              for (var iAct=1;iAct<Les_ACTIONS.length-1;iAct++){
                ...
                LesActions[iAct-1]=creerAction(act, champs[1], champs[2], champs[3], champs[4], champs[5], champs[6],champs[7], Periodes);
              }    
              if (LesActions.length==0){  //Action Triac
                  LesActions.push( creerAction(false, "Titre Triac", "", 50, "", "","", 0, [{
                          Hfin: 2400,
                          Type: 4,
                          Vmin:0,
                          Vmax:100,
              ...
              LesActions.push( creerAction(false, "Titre", "localhost", 80, "", "", 240,0, [{
                      Hfin: 2400,
                      Type: 3,
                      Vmin:0,
                      Vmax:0,
